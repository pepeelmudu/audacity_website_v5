    ...
    <footer className="w-full bg-[#030c2f] py-12 md:py-16">
      <div className={`mx-auto px-6 md:px-10 ${isMobile ? 'max-w-[280px]' : 'max-w-5xl'}`}>
        ...
        {isMobile ? (
          ...
          <div className="flex justify-between items-start gap-4 mb-6">
            ...
            <div className="text-center flex-1">
              <h4 className="text-[#a8d5c2] font-semibold mb-1 text-[9px]">Help</h4>
              <ul className="space-y-0.5">
                {helpSupport.map((link, index) => (
                  <li key={index}>
                    <Link 
                      href={link.href}
                      className="text-[#a8d5c2]/70 text-[8px] hover:text-[#a8d5c2] transition-colors duration-200"
                    >
                      {link.label}
                    </Link>
                  </li>
            ...
            {/* Company */}
            <div className="text-center flex-1">
              <h4 className="text-[#a8d5c2] font-semibold mb-1 text-[9px]">Company</h4>
              <ul className="space-y-0.5">
            ...
            {/* Legal */}
            <div className="text-center flex-1">
              <h4 className="text-[#a8d5c2] font-semibold mb-1 text-[9px]">Legal</h4>
              <ul className="space-y-0.5">
        ...
        <div className={`flex flex-col md:flex-row justify-between items-center gap-4 ${isMobile ? 'text-center' : ''}`}>
          {/* Copyright */}
          <p className={`text-[#a8d5c2]/50 ${isMobile ? 'text-[8px]' : 'text-[10px]'}`}>
