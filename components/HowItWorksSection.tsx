...
const steps = [
  {
    ...
    icon: "/3d_assets/how_to/green/1g.png",
  },
  {
    number: "Step 2",
    ...
    icon: "/3d_assets/how_to/green/2g.png",
  },
  {
    number: "Step 3",
    ...
    icon: "/3d_assets/how_to/green/3g.png",
  },
  {
    number: "Step 4",
    title: "Build Your Team",
    description: "Hire your exceptional human.",
    icon: "/3d_assets/how_to/green/4g.png",
  },
];
      ...
      <div className="max-w-4xl mx-auto px-6 md:px-10">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-20">
          {steps.map((step, index) => (
            <div key={index} className="flex flex-col">
              {/* Icon Box */}
              <div className="border border-[#0a2540] p-3 mb-3 aspect-square flex items-center justify-center bg-transparent">
                <Image
                  src={step.icon}
                  alt={step.title}
                  width={120}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          {testimonials.map((testimonial, index) => (
            <div key={index} className="border border-[#0a2540] overflow-hidden bg-transparent">
              {/* Image */}
